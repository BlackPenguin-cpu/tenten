...
namespace Febucci.UI.Effects
{
    ...
    [CreateAssetMenu(menuName = "Text Animator/Animations/Appearances/Shake", fileName = "Shake Appearance")]
    [EffectInfo("shake", EffectCategory.Appearances)]
    [DefaultValue(nameof(baseAmplitude), 1.13f)]
    [DefaultValue(nameof(baseDelay), .1f)]
    [DefaultValue(nameof(baseWaveSize), .45f)]
    public sealed class ShakeAppearance : AppearanceScriptableBase
    {
        //---BASE VALUES---
